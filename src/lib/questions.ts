...
export const quizzes: QuizData = {
  ba: {
    ...
    missions: [
      {
        id: 'm1_ba',
        title: 'Misión 1: Fundamentos y Herramientas Digitales',
        narrative: 'Tu viaje comienza aquí. Domina las plataformas clave de Aviva y los requisitos esenciales para cada solicitud. ¡Este conocimiento es tu base para el éxito!',
        questions: baQuestions.slice(0, 8),
      },
      {
        id: 'm2_ba',
        title: 'Misión 2: El Producto "Aviva Tu Compra"',
        narrative: "Conoce a fondo el crédito 'Aviva Tu Compra'. Aprende sobre los montos, tasas y las categorías que financiamos para asesorar a tus clientes como un experto.",
        questions: baQuestions.slice(8, 16),
      },
      {
        id: 'm3_ba',
        title: 'Misión 3: El Proceso de Solicitud',
        narrative: 'Guía a tus clientes por el camino de la solicitud. Desde los documentos necesarios y la firma del contrato hasta cómo manejar un rechazo. ¡Tu pericia es clave!',
        questions: baQuestions.slice(16, 24),
      },
      {
        id: 'm4_ba',
        title: 'Misión 4: Gestión de Pagos',
        narrative: 'Un crédito exitoso requiere una gestión de pagos impecable. Domina los métodos de pago, las políticas de cancelación y los cargos por mora para mantener todo en orden.',
        questions: baQuestions.slice(24, 32),
      },
      {
        id: 'm5_ba',
        title: 'Misión 5: Pagos Avanzados y Cierre',
        narrative: '¡Estás en la recta final! Conviértete en un maestro de la gestión avanzada de pagos, liquidaciones anticipadas y el proceso de cierre para completar la misión con honores.',
        questions: baQuestions.slice(32, 40),
      },
    ],
  },
  atn: {
    ...
    missions: [
      ...
      },
      {
        ...
        questions: atnQuestions.slice(33, 44),
      },
      {
        id: 'm5_atn',
        ...
        questions: atnQuestions.slice(44, 55),
      },
    ],
  },
};
